...
torch::data::Example<> C4Dataset::get(size_t index) { return {m_Data[index].first, m_Data[index].second}; }

torch::optional<size_t> C4Dataset::size() const { return m_Data.size(); }
