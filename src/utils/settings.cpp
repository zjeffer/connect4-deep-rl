...
bool Settings::useCUDA() const { return m_useCUDA; }

void Settings::setuseCUDA(bool useCUDA) { m_useCUDA = useCUDA; }
...
int Settings::getRows() const { return m_Rows; }

void Settings::setRows(int rows) { m_Rows = rows; }

int Settings::getCols() const { return m_Cols; }

void Settings::setCols(int cols) { m_Cols = cols; }

int Settings::getInputPlanes() const { return m_InputPlanes; }

void Settings::setInputPlanes(int inputPlanes) { m_InputPlanes = inputPlanes; }

int Settings::getOutputSize() const { return m_Cols; }

std::string Settings::getModelPath() const { return m_ModelPath; }
